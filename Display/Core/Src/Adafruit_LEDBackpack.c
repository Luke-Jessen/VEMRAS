...
void begin(uint8_t _addr) {
  ...
  blinkRate(HT16K33_BLINK_OFF, _addr);

  setBrightness(15, _addr); // max brightness
...
void writeDigitAscii(uint8_t n, uint8_t a, bool d) {
